    ...
    <div className="flex bg-blue-400 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10">
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        <div className="text-xl sm:text-2xl md:text-3xl lg:text-5xl text-white font-semibold">
          <p>Book Appoinment</p>
          <p className="mt-4">With 100+ Trusted Councellors</p>
        </div>
        <button
          onClick={() => {
            navigate("/login");
          ...
          className="bg-white rounded-full text-sm sm:text-base text-gray-600 px-8 py-3 hover:scale-105 transition-all mt-4"
        >
          Create Account
        </button>
      </div>
